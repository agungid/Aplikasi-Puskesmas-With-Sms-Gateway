	...
	<form name="form1" method="post" action="php/proses.php">
		<table width="95%" >
			...
			<tr>
				 ...
				 <td><input name="data[]" type="text"  size="50" required placeholder="Nama Anggota"/></td>
			</tr>
			<tr>
				  <td><b>Tempat Lahir</b></td>
				 <td><input name="data[]" type="text" size="30" required placeholder="Tempat Lahir" onKeyPress="return namesonly(this, event)"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td><b>Alamat</b></td>
				<td><textarea name="data[]" rows="3" cols="20" arequired="" placeholder="Alamat Anggota"/></textarea></td>
			</tr>
			<tr>  
				<td><b>No.Telp</b></td>
			...
			<tr>  
				<td><b>Nama Bayi</b></td>
				<td><input name="data[]" type="text" size="50" required="" placeholder="Nama Bayi" onKeyPress="return namesonly(this,event)"/></td>
			</tr> 
			<tr>  
				<td><b>Nama Ayah</b></td>
				<td><input name="data[]" type="text" size="50" required placeholder="Nama Ayah " onKeyPress="return namesonly(this, event)"/></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>
